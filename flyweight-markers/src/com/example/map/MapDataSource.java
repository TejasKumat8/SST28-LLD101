 ...
 *
 * Uses MarkerStyleFactory so identical style configurations share the same
 * MarkerStyle instance (Flyweight pattern).
 */
public class MapDataSource {
    ...
    public List<MapMarker> loadMarkers(int count) {
        ...
        for (int i = 0; i < count; i++) {
            ...
            // Obtain shared style from factory instead of creating new each time
